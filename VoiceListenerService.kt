...
class VoiceListenerService : Service() {
    ...
    private var isActive = false // toggled by "command on" / "command off"
    ...
    private fun startListening() {
        ...
        speechRecognizer?.setRecognitionListener(object : RecognitionListener {
            ...
            override fun onError(error: Int) {
                // No speech / timeout / busy -> just restart, this is a continuous loop
                restartListening()
            }
    ...
    private fun handleSpokenText(spoken: String) {
        ...
        // Wake word toggle always works, regardless of current state
        ...
        // Ignore everything else unless activated
        if (!isActive) return
        ...
        when {
            ...
            // Sab kuch aur ignore — sirf "open" aur "call" commands ka jawab dete hain
        }
    }
